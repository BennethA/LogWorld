...
const Title = ({
  ...
  return (
    <div className={`flex flex-col items-center z-10`}>
      ...
      >
        <h1
          className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center font-bold font-serif ${
            darkMode ? "text-gray-300" : "text-[#16161f]"
          }`}
        >
        ...
        <p
          className={`w-full sm:w-[80%] leading-[20px] md:text-lg text-center font-semibold ${
            darkMode ? "text-gray-300" : "text-[#16161fd3]"
          }`}
        >
          {description}
        </p>
